...
<h3 id=setMgrCallback>-(void) setMgrCallback:(id&lt;CloudroomVideoMgrCallBack&gt;)callBack </h3>
...
<h3 id=getMeetingSuccess>- (void)getMeetingListSuccess:(ArrayList&lt; MeetInfo *&gt;  *)meetList cookie:(NSString *)cookie</h3>
...
| 参数 | 类型 | 含义 |
|:-------- |:-----------|:----------|
| meetList| MeetInfo|     房间信息, 详见定义[MeetInfo](TypeDefinitions.md#MeetInfo)|
| cookie| String|     自定义用户数据|

<h3 id=getMeetingFailed>- (void)getMeetingListFail:(CRVIDEOSDK_ERR_DEF)sdkErr cookie:(NSString *)cookie</h3>
...
<h3 id=setQueueCallback>- (void)setQueueCallback:(id )callBack;</h3>
...
<h3 id=setHttpFileMgrCallback>- (void)setHttpFileMgrCallback:(id )callBack</h3>
