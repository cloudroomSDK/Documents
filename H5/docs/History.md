...
- [点此下载](https://sdk.cloudroom.com/download.html) 最新版WebSDK 及 Demo
- CDN：*&lt;script src="https://sdk.cloudroom.com/web/download/SDK/H5SDK/latest/RTCSDKV2.min.js"&gt;&lt;/script&gt;*

## 版本变更记录

### 2022-03-28 &ensp;&ensp; V2.5.8.1
  ...
  6. 本次更新涉及接口变动，详见开发文档
     * [CRVideo_SetAudioCfg](API.html#CRVideo_SetAudioCfg)

### 2022-03-23 &ensp;&ensp; V2.5.7.11
  1. SDK：解决无法指定使用VP8编码的问题；
  2. SDK：新增音视频媒体流日志；
  3. SDK：修复某些情况下开麦后听不到房间内声音的问题；
  4. Demo：呼叫demo支持被叫端创建房间；

### 2022-03-17 &ensp;&ensp; V2.5.7.8
  1. Demo：PC会议Demo调整邀请自定义内容格式；
  2. Demo：PC会议Demo支持邀请sip设备；
  3. SDK：解决上个版本某些情况下ios微信内无法观看远端视频的问题；

### 2022-03-07 &ensp;&ensp; V2.5.7.5
  1. SDK：音频新增对nack的支持；

### 2022-03-03 &ensp;&ensp; V2.5.7.4
  1. Demo：修改云端录制参数，type7改为type10，兼容非桌面录制服务；

### 2021-02-22 &ensp;&ensp; V2.5.7.3
  1. SDK：新增查询主视频模式接口；
  2. SDK：新增更多清晰度选择；
  ...
  6. 本次更新涉及接口变动，详见开发文档
     * [CRVideo_GetMainVideoMode（新增）](API.html#CRVideo_GetMainVideoMode)
     * [CRVideo_StartPlayMedia](API.html#CRVideo_StartPlayMedia)

### 2021-01-11 &ensp;&ensp; V2.5.5.7
...
*&lt;script src="https://sdk.cloudroom.com/web/download/SDK/H5SDK/2.5.3.2/RTCSDKV2.min.js"&gt;&lt;/script&gt;*
  ...
  5. 本次更新涉及接口变动（相对于2.5.2.x），详见开发文档
     * [CRVideo_SetVideoCfg（原参数不变，新增参数）](API.html#CRVideo_SetVideoCfg)

### 2021-09-02 &ensp;&ensp; V2.5.2.3
*&lt;script src="https://sdk.cloudroom.com/web/download/SDK/H5SDK/2.5.2.3/RTCSDKV2.min.js"&gt;&lt;/script&gt;*
  ...
  9. 本次更新涉及接口变动（相对于2.5.1.x），详见开发文档
     * [CRVideo_SetVirtualBackground](API.html#CRVideo_SetVirtualBackground)
     * [CRVideo_BoardUIObj.importImg](API.html#CRVideo_BoardUIObj_importImg)
     * [CRVideo_BoardUIObj.getCanvasElement](API.html#CRVideo_BoardUIObj_getCanvasElement)

### 2021-08-18 &ensp;&ensp; V2.5.1.6
*&lt;script src="https://sdk.cloudroom.com/web/download/SDK/H5SDK/2.5.1.6/RTCSDKV2.min.js"&gt;&lt;/script&gt;*
  ...
  11. 本次更新涉及接口变动（相对于2.5.0.x），详见开发文档
      * [CRVideo_StartSvrMixer](API.html#CRVideo_StartSvrMixer)（改为promise）
      * [CRVideo_UpdateSvrMixerContent](API.html#CRVideo_UpdateSvrMixerContent)（改为promise）
      * [CRVideo_StopSvrMixer](API.html#CRVideo_StopSvrMixer)（改为promise）
      * [CRVideo_OpenMic](API.html#CRVideo_OpenMic)（改为promise）
      * CRVideo_EnterMeeting（废弃）
      * CRVideo_EnterMeeting2（废弃）
      * [CRVideo_EnterMeeting3](API.html#CRVideo_EnterMeeting3)（新增）

### 2021-08-03 &ensp;&ensp; V2.5.0.2
