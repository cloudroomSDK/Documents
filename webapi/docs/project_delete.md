...
https://www.cloudroom.com/CLOUDROOM-API/project/delete
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td  colspan="2" style="font-weight:normal;">删除项目账号的id</td>
        </tr>
    </tbody>   
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td style="font-weight:normal;">23</td>
            <td  colspan="2" style="font-weight:normal;">删除账号包含队列数据</td>
        </tr>
        <tr>
            <td style="font-weight:normal;">24</td>
            <td  colspan="2" style="font-weight:normal;">不能删除默认项目账号</td>
        </tr>
    </tbody>   
</table>
